...
public class amazon_testcase_checkout extends Launch_quit
{
	@Test
	public void checking_out_product() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		c1.add_to_cart();
		amazon_checkout c2=new amazon_checkout(driver);
		c2.checkout_product();
