...
public class amazon_testcase_couponcode extends Launch_quit
{
	@Test
	public void apply_coupon() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		amazon_couponcode c2=new amazon_couponcode(driver);
		c2.apply_coupon_code();
	}
}
